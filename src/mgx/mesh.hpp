...
namespace mgx {
	...
	struct MeshInstance {
		...
		// direction
		// glm::vec3 front_normal = glm::vec3(0.0f, 0.0f, 1.0f);
		// glm::vec3 up_normal    = glm::vec3(0.0f, 1.0f, 0.0f);
		// glm::vec3 right_normal = glm::vec3(1.0f, 0.0f, 0.0f);

		// rotation
		float rotation_rads 	= 0.0f;
		glm::vec3 rotation_axis = glm::vec3(1.0f);
		...
		glm::mat4 ModelMatrix() const {
			return glm::translate	(glm::mat4(1.0f), position) *
				   ...
				   glm::rotate		(glm::mat4(1.0f), rotation_rads, rotation_axis);
		}
	};
}
